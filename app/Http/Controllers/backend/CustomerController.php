...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('customers.view')->with('success','Successfully Data Inserted');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('customers.view')->with('success','Update data Successfully');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('customers.view')->with('success','Delete data Successfully');
    ...
    public function customerWiseBoth(Request $request)
    {
        $data['allData'] = Payment::where('customer_id',$request->customer_id)->get();
        $pdf = PDF::loadView('backend.pdf.customer-wise-both-pdf', $data);
        $pdf->SetProtection(['copy', 'print'], '', 'pass');
        return $pdf->stream('document.pdf');
    }
}
