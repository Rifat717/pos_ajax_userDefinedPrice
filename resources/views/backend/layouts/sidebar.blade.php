...
<nav class="mt-2">
	<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		...
		<li class="nav-item has-treeview {{ ($prefix=='/suppliers')?'menu-open':'' }}">
			...
			<ul class="nav nav-treeview">
				<li class="nav-item">
					<a href="{{ route('suppliers.credit') }}" class="nav-link {{ ($route=='suppliers.credit')?'active':'' }}">
						<i class="far fa-circle nav-icon"></i>
						<p>Credit Supplier</p>
					</a>
				</li>
			...
			<ul class="nav nav-treeview">
				<li class="nav-item">
					<a href="{{ route('suppliers.paid') }}" class="nav-link {{ ($route=='suppliers.paid')?'active':'' }}">
						<i class="far fa-circle nav-icon"></i>
						<p>Paid Supplier</p>
					</a>
				</li>
			...
			<ul class="nav nav-treeview">
				<li class="nav-item">
					<a href="{{ route('suppliers.wise.report') }}" class="nav-link {{ ($route=='suppliers.wise.report')?'active':'' }}">
						<i class="far fa-circle nav-icon"></i>
						<p>Supplier Wise Report</p>
					</a>
				</li>
			</ul>
		...
		<li class="nav-item has-treeview {{ ($prefix=='/purchase')?'menu-open':'' }}">
			...
			<ul class="nav nav-treeview">
				...
				<li class="nav-item">
					<a href="{{ route('purchase.print.list') }}" class="nav-link {{ ($route=='purchase.print.list')?'active':'' }}">
						<i class="far fa-circle nav-icon"></i>
						<p>Print Purchase</p>
					</a>
				</li>
